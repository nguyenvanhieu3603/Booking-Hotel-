...
INSERT INTO `bookings` (`id`, `userId`, `hotelId`, `roomId`, `checkInDate`, `checkOutDate`, `totalPrice`, `status`, `createdAt`) VALUES
(1, 1, 1, 1, '2023-12-01', '2023-12-05', 5000000.00, 'confirmed', '2025-05-12 22:48:12');
...
INSERT INTO `payments` (`id`, `bookingId`, `paymentMethod`, `amount`, `status`, `paidAt`, `createdAt`) VALUES
(1, 1, 'credit_card', 5000000.00, 'pending', NULL, '2025-05-12 22:48:45');
...
INSERT INTO `reviews` (`id`, `userId`, `hotelId`, `bookingId`, `rating`, `comment`, `createdAt`) VALUES
(1, 1, 1, 1, 5, 'Khách sạn tuyệt vời!', '2025-05-12 22:49:10');
...
INSERT INTO `users` (`id`, `fullName`, `email`, `password`, `phone`, `role`, `createdAt`, `is_verified`, `otp_code`, `otp_expires_at`) VALUES
(1, 'Nguyễn Văn A', 'anhkocaycaycay@gmail.com', '$2y$10$ELFhiZE7xnaEaUY93nL09uP3WaqFfxyuGPbVjAVr60EGbWRT29EuG', '0123456789', 'customer', '2025-05-12 22:42:56', 1, NULL, NULL),
(3, 'Trần Văn C', 'anhcaycaycay@gmail.com', '$2y$10$avjI7WnKaH1lcxgb5bzbtOm7/G4UnymrfcoETbvu8mTlsQ2lj0OoG', '0123456789', 'customer', '2025-05-15 18:19:10', 1, NULL, NULL),
(5, 'Trần Văn D', 'chubblineb@gmail.com', '$2y$10$MCFPN0CfPADKAktiYeOUeOQ.XPzizucD4BIqw.sAYFildn81iFzHy', '123456789', 'customer', '2025-05-15 20:46:05', 0, '162855', '2025-05-15 15:51:05');
