...
const ChatInput = ({ onSendMessage, isLoading = false }) => {
  ...
  // Quick suggestions based on login status
  const getQuickSuggestions = () => {
    const baseSuggestions = [
      "Tìm khách sạn gần trường Đại học Mỏ Địa Chất",
      "Khách sạn nổi bật",
      "Xem phòng còn trống tại khách sạn Peaceful Stay vào cuối tuần này",
    ];
    ...
    if (isAuth) {
      return [
        ...
        "Đặt phòng ở Lake View Inn cho cuối tháng này cho 2 người",
      ];
    }
    ...
    <div className="border-t border-gray-200 bg-white p-4">
      ...
      {!isAuth && (
        <div className="mt-2 text-xs text-gray-500 flex items-center">
          ...
          Đăng nhập để sử dụng tính năng đặt phòng và xem lịch sử
        </div>
      )}
    </div>
  );
