                ...
                <div className="flex flex-wrap gap-2">
                  {[5, 4, 3, 2].map((rating) => (
                    <button
                      ...
                      className={`px-3 py-1 rounded-full border border-gray-300 text-gray-700 ${starRating === rating ? "bg-[#febb02] text-white" : "bg-white hover:bg-[#d89b00] hover:text-white"} shadow-md transition`}
            ...
            <div className="flex justify-center mt-10">
              <nav className="inline-flex items-center space-x-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-l-md border border-gray-200 bg-white text-[#003b95] font-semibold hover:bg-[#febb02] hover:text-white transition-colors ${currentPage === 1 ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}>
                  &larr;
                </button>
                {[...Array(totalPages)].map((_, idx) => (
                  <button
                    ...
                    className={`px-4 py-2 border border-gray-200 font-semibold rounded-md transition-colors ${currentPage === idx + 1 ? 'bg-[#003b95] text-white shadow-sm' : 'bg-white text-[#003b95] hover:bg-[#febb02] hover:text-white'}`}>
                    {idx + 1}
                  </button>
                ))}
                <button
                  ...
                  className={`px-4 py-2 rounded-r-md border border-gray-200 bg-white text-[#003b95] font-semibold hover:bg-[#febb02] hover:text-white transition-colors ${currentPage === totalPages ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}>
                  &rarr;
                </button>
              </nav>
            </div>
